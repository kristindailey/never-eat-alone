                    ...
                    <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
                        ...
                        <div className="md:ml-auto">
                            <div className="flex space-x-2">
                                ...
                                <a href="/add-meetup" className="text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2">Add Meetup</a>
                                <a href="/profile" className="text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2">Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
